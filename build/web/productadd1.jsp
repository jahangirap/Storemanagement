	...
	<div class="header">
      ...
      <div class="header-menu">
                	<ul>
                        ...
                        <li><a href="Customerwisereport.htm">Customerwisereport</a></li>
                        <li><span class="active2 margin3">&nbsp;</span><a href="Untitled-1.htm">Collected Products</a></li>
    	...
    	<div class="content">
            <h:form>
             <h:panelGrid columns="2">
                                            ...
                                            <rich:comboBox id="cat" value="#{ProductBean.catname}" directInputSuggestions="true" defaultLabel="Select Catagory:" enableManualInput="false">
                                                <f:selectItems value="#{ProductBean.catValue}"/>
                                                <a4j:support action="#{ProductBean.productname}" reRender="product" event="onchange" ajaxSingle="true"/>
                                            </rich:comboBox>


                                            <h:outputText value="Product Name:"/>
                                            <rich:comboBox id="product" value="#{ProductBean.productname}" directInputSuggestions="true" defaultLabel="Select subcatagory:">
                                        ...
                                        <h:commandButton value="Insert" action="#{ProductBean.subcatinsert}"  /><rich:spacer width="15px"/>
                                        </h:form>
        </div>
    	<div class="clear"></div>
    </div>
