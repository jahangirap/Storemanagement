    ...
    <div class="bodycontent">
    	<div class="content">
            ...
            <h:form>
                ...
                <h:outputText value="" >Select Category Name:</h:outputText>
                
                <h:selectOneMenu value="#{CategoryBean.catname}" id="catname" /><br/>
                <h:outputText value="New Category Name:"></h:outputText>
                <h:inputText value="#{CategoryBean.newcatname}" id="newcatname"></h:inputText>
            ...
            <h:commandButton value="Update" action="#{CategoryBean.update}" />
