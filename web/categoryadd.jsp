    	...
    	<div class="content">
            ...
            <h:form enctype="multipart/form-data">
               ...
               <h:panelGrid columns="4" width="600px">
                                            ...
                                            <rich:comboBox id="catname" value="#{CategoryBean.catname}"  selectFirstOnUpdate="true" directInputSuggestions="true" defaultLabel="Select Category Name:">
                                                <f:selectItems value="#{CategoryBean.userName}"/>
                                                <a4j:support action="#{CategoryBean.changeItem}" reRender="desc" event="onchange" ajaxSingle="true"/>
                                            </rich:comboBox>



                                            <h:outputText value="Category Desc:" style="text-align:top;"/>
                                            <h:inputTextarea id="desc"  value="#{CategoryBean.catdesc}" cols="40" /> 
                                        ...
                                        <h:panelGrid columns="3" width="300px">
                                            ...
                                            <h:commandButton  value="Insert" action="#{CategoryBean.insert}" onclick="if (!confirm('Are you sure you want to submit this record?')) return false"/>
                                        </h:panelGrid>
            </div>
            </h:form>
