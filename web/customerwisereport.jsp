...
<body>
  ...
  <h:outputText value="#{CustomerViewBean.msg}"/>   <br/>
                    
                

 <h:outputText value="Product Category:"/>
  <rich:comboBox id="catnam" value="#{CustomerViewBean.catname}"  selectFirstOnUpdate="true" directInputSuggestions="true" defaultLabel="Select Category Name:">
                                                <f:selectItems value="#{CustomerViewBean.catValue}"/>
                                                <a4j:support action="#{CustomerViewBean.loadcat}" reRender="productname,desc" event="onchange" ajaxSingle="true"/>
  </rich:comboBox><br/>
                   
    
     
 <h:outputText value="Products Name:"/> 
 <rich:comboBox id="productname" value="#{CustomerViewBean.productname}"  selectFirstOnUpdate="true" directInputSuggestions="true" defaultLabel="Select Category Name:">
                                                <f:selectItems value="#{CustomerViewBean.productValue}"/>
                                               </rich:comboBox><br/>
  
<h:outputText value="Product Avaiable:"/>
<h:inputText id="availableQty" value="#{CustomerViewBean.availableQty}"/><br/>
                
                <h:outputText value="Customer ID:"/>
                <h:inputText id="customerid"  value="#{CustomerViewBean.customerid}"/><br/>
                
                <h:outputText value="Customer Name:"/>
                <h:inputText id="customername"  value="#{CustomerViewBean.customername}"/><br/>
                
                <h:outputText value="Room No:"/>
                <h:inputText id="roomno"  value="#{CustomerViewBean.roomno}"/><br/>
                <h:outputText value="Purchase Date:"/>
 <rich:calendar value="#{CustomerViewBean.date}" id="date" datePattern="yyyy-MM-dd"/><br/>
                <h:commandButton value="SAVE" action="#{CustomerViewBean.insert}" />
            </div>
            </h:form>
